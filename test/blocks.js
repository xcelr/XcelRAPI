...
describe('Blocks', function() {
  describe('/blocks/:blockHash route', function() {
    ...
    var xclcoreBlock = xclcore.Block.fromBuffer(new Buffer(blocks['0000000000000afa0c3c0afd450c793a1e300ec84cbe9555166e06132f19a8f7'], 'hex'));

    var node = {
      log: sinon.stub(),
      getBlock: sinon.stub().callsArgWith(1, null, xclcoreBlock),
      services: {
        xcelrd: {
    ...
    it('block pool info should be correct', function(done) {
      var block = xclcore.Block.fromString(blocks['000000000000000004a118407a4e3556ae2d5e882017e7ce526659d8073f13a4']);
      var node = {
        log: sinon.stub(),
